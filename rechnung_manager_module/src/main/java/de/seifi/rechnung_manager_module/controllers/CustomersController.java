...
public class CustomersController implements Initializable, ControllerBase {
    ...
    public void deleteCutomer(ActionEvent actionEvent) {
        if(selectedModel != null){
        	...
        	if(RechnungManagerServiceProvider.getCustomerService().hasRechnung(selectedModel)) {
        	...
        	if(result.isPresent() && result.get() == ButtonType.OK) {
                RechnungManagerServiceProvider.getCustomerService().delete(selectedModel);
            	reload(null);
        	}
    ...
    public void saveCutomer(ActionEvent actionEvent) {
        ...
        RechnungManagerServiceProvider.getCustomerService().save(editingModel);
    ...
    public void reload(ActionEvent actionEvent) {
        RechnungManagerServiceProvider.getCustomerService().reloadCustomerList();
    	
    	List<CustomerModel> allCustomerList = RechnungManagerServiceProvider.getCustomerService().getCustomerList();
