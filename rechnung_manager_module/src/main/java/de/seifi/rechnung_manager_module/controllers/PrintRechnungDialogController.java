...
import de.seifi.rechnung_manager_module.fx_services.RechnungBindingPrintService;
...
public class PrintRechnungDialogController implements Initializable {
    ...
    public void printRechnungList(RechnungModel model, CustomerModel customerModel, PrinterJob job){
        ...
        if (job != null) {
            ...
            job.showPrintDialog(UiUtils.getMainAppProvider().getWindow());
            job.showPageSetupDialog(UiUtils.getMainAppProvider().getWindow());
