...
public class RechnungControllerBase implements Initializable, ControllerBase {
    ...
    public RechnungControllerBase(RechnungType rechnungType) {
	...
	public void loadModel(RechnungModel rechnungModel, boolean editable, Stage stage) {
        ...
        CustomerModel customerModel = customerEntityOptional.get().toModel();

		showItemsTableView.setEditable(editable);
		rechnungBindingService.setRechnungModel(rechnungModel, customerModel);
		...
		if(!editable) {
            ...
            if(this.rechnungType == RechnungType.RECHNUNG){
                ...
                txtName.setText(customerModel.getCustomerName());
                txtStreet.setText(customerModel.getStreet());
                txtPlz.setText(customerModel.getPlz());
                txtAddress2.setText(customerModel.getAddress2());
                txtCity.setText(customerModel.getCity());
                txtHaus.setText(customerModel.getHouseNumber());
            }
