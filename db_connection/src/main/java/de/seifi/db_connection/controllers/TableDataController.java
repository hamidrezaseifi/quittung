...
public class TableDataController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		try {
			...
			DbConnectionFxApp.showError("Tabelle-Info extrahieren ...", "Fehler:" + e.getLocalizedMessage());
			e.printStackTrace();
		}catch (Exception e) {
			DbConnectionFxApp.showError("Tabelle-Info extrahieren ...", "Fehler:" + e.getLocalizedMessage());
			e.printStackTrace();
	...
	private void clearTable() {
		try {
			...
			DbConnectionFxApp.showError("Tabelle-Info leeren ...", "Fehler:" + e.getLocalizedMessage());
			e.printStackTrace();
		}
	}
